...
GPT-4 with Vision is a powerful tool for processing images and text in the same prompt. To use the OpenAI Vision model with Kirby Copilot, you need to have an OpenAI API key and access to the `gpt-4o` model.

...
Placeholders are also available in the [Copilot Panel section](/docs/configuration/section). You could set up a Copilot section for the meta description field with a [predefined user prompt](/docs/examples/blueprints#predefined-user-prompt) for a smooth workflow.
::

...
<template>
  <div v-if="page">
    ...
    >
      ...
      <template #video>
        <div
          class="hover:ring-primary-500 dark:hover:ring-primary-400 group relative cursor-pointer rounded-xl shadow ring-1 ring-gray-200 dark:ring-gray-800"
        >
          <div class="aspect-[16/9] w-full">
            <ClientOnly>
              <lite-youtube
                videoid="q-ihIDtvn-s"
                muted
                class="max-w-none rounded-xl"
                :style="{
                  backgroundImage: 'url(/kirby-copilot-demo-poster.jpg)',
                }"
              />
            </ClientOnly>
          </div>
